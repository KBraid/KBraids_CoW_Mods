var Constructor = function()
{
    ...
    this.getMovementpoints = function(terrain, unit, currentTerrain, trapChecking = false, map)
    {
        ...
        return MOVEMENTTABLE.getMovementpointsFromTable(terrain, MOVE_ALL_TERRAIN.movementpointsTable);
    };
};
Constructor.prototype = MOVEMENTTABLE;
var MOVE_ALL_TERRAIN = new Constructor();
